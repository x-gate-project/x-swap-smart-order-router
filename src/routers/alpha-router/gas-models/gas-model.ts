...
import {
  ...
  USDC_POLYGON,
  USDC_SEPOLIA,
  USDCX_ARBITRUM_SEPOLIA,
  USDCX_AVALANCHE_FUJI,
  USDCX_BASE_SEPOLIA,
  USDCX_JOC_MAINNET,
  USDCX_JOC_TESTNET,
  USDT_ARBITRUM,
  ...
  USDTX_ARBITRUM_SEPOLIA,
  USDTX_AVALANCHE_FUJI,
  USDTX_BASE_SEPOLIA,
  USDTX_JOC_MAINNET,
  USDTX_JOC_TESTNET,
  WBTC_GOERLI,
...
export const usdGasTokensByChain: { [chainId in ChainId]?: Token[] } = {
  ...
  [ChainId.ARBITRUM_SEPOLIA]: [USDC_ARBITRUM_SEPOLIA, USDTX_ARBITRUM_SEPOLIA, USDCX_ARBITRUM_SEPOLIA],
  [ChainId.BASE_SEPOLIA]: [USDC_BASE_SEPOLIA, USDTX_BASE_SEPOLIA, USDCX_BASE_SEPOLIA],
  [ChainId.AVALANCHE_FUJI]: [USDC_AVALANCHE_FUJI, USDTX_AVALANCHE_FUJI, USDCX_AVALANCHE_FUJI],
};
